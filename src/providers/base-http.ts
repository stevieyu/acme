...
export abstract class HttpProviderBase implements DnsProvider {
  ...
  abstract createTxtRecord(ctx: DnsProviderContext, record: TxtRecordInput): Promise<void>
  abstract deleteTxtRecord(ctx: DnsProviderContext, record: TxtRecordInput): Promise<void>
}
